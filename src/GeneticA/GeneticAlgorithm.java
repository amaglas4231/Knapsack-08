...
public class GeneticAlgorithm {
    ...
    private static double MutationRate = 0.75;
    ...
    public static ArrayList<ArrayList<Integer>> Crossover() {
        ...
        for (int j = 0; j < 10; j++) {
            ...
            for (int i = 0; i < 5; i++) {
                // randomly create subgroups of 5 from initial Population
                SubGroup.add(PopulationLea.Population.get(ThreadLocalRandom.current().nextInt(0, 100)));
            }
    ...
    public static void RunGa() {
        ...
        // score of fitness function:
        System.out.println("Best fitness score is : " + PopulationLea.score[PopulationLea.Population.size() - 1]);
