...
public class UserVariables {
    ...
    public static double ContainerVolume = 165;
    static int constant = 50;
    static int score = 0;
    ...
    public static int[][][] container = new int[container_width / constant][container_heigth / constant][container_depth
            / constant];
